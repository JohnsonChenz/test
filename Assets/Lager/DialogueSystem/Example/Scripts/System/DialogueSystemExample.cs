...
{
    private static DialogueSystemExample _instance;    // 對話系統單例

    public static DialogueSystemExample GetInstance()
    {
        if (_instance == null) _instance = new DialogueSystemExample();
        return _instance;
    }
